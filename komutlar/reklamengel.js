...
exports.run = async (bot, message, args) => {
  ...
  if (args[0] == 'aç') {
    db.set(`reklam_${message.guild.id}`, 'acik').then(i => {
      message.channel.send('Reklam Engel başarıyla açıldı! `Üyeleri Yasakla` yetkisine sahip olanların reklamı engellenmeyecektir.')
    })
  }
  if (args[0] == 'kapat') {
...
exports.help = {
  name: 'reklamengel',
  kategori: 'ayarlar',
  description: 'Reklam engelleme komutu',
  usage: 'reklamengel'
};