...
exports.run = async (client, message, args) => {
  ...
  .setDescription(`**Çekiliş kanalını etiketlemelisin! ** ***\`\`\`${prefix}çekiliş #çekiliş 5 gün Steam Key\`\`\`\n***`)
...

  {
    ...
    .setColor("ff0000")
    .setTitle(`${message.guild.name} - Çekiliş Sistemi `)
    .setDescription(`**Bir süre yazmalısın!** ***\`\`\`${prefix}çekiliş #çekiliş 5 gün Steam Key\`\`\`\n***`)
              .setThumbnail('https://i.ibb.co/H2q4pDb/cekilis2.png')
        .setTimestamp()
...

  {
    ...
    .setColor("ff0000")
    .setTitle(`${message.guild.name} - Çekiliş Sistemi `)
    .setDescription(`**Süreyi doğru yazmalısın!** ***\`\`\`${prefix}çekiliş #çekiliş 5 gün Steam Key\`\`\`\n***`)
    .setThumbnail('https://i.ibb.co/H2q4pDb/cekilis2.png')
        .setTimestamp()
  ...
  
  {
    ...
    .setColor("ff0000")
    .setTitle(`${message.guild.name} - Çekiliş Sistemi `)
    .setDescription(`**Ödülü yazmalısın.**${prefix}çekiliş #çekiliş 5 gün Steam Key**`)
    .setThumbnail('https://i.ibb.co/H2q4pDb/cekilis2.png')
        .setTimestamp()
